...
CREATE TABLE actor_profile_observations (
...
CREATE INDEX idx_actor_profile_observations_actor_id
ON actor_profile_observations (source_kind, source_actor_id, observed_at DESC);
...
CREATE INDEX idx_media_last_observed_at
ON media (source_kind, last_observed_at DESC);
...
CREATE TABLE media_variants (
    ...
    FOREIGN KEY (source_kind, source_media_id)
        REFERENCES media(source_kind, source_media_id)
        ON DELETE CASCADE
);
